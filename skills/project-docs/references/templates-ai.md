...
"FastAPI сервис для импорта и валидации уроков LMS из CSV. Точка входа для контент-пайплайна."}}
...
### Пример
**Lesson** — единица учебного контента в LMS. Представлена `app/models/lesson.py:Lesson`. Не путать с **Course** (контейнер уроков) и **Unit** (логическая группа внутри course).
